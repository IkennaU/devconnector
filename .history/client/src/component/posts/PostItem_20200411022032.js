      ...
      <div classNames="card card-body mb-3">
        <div classNames="row">
          ...
          <div classNames="col-md-10">
            <p classNames="lead">{post.text}</p>
            <button type="button" classNames="btn btn-light mr-1">
              <i classNames="text-info fas fa-thumbs-up"></i>
              <span classNames="badge badge-light">{post.likes.length}</span>
            </button>
            <button type="button" classNames="btn btn-light mr-1">
              <i classNames="text-secondary fas fa-thumbs-down"></i>
            </button>
            <Link to={`/post/${post._id}`} classNames="btn btn-info mr-1">
              Comments
            </Link>
            {post.user === auth.user.id ? ( <button onClick={this.onDeleteClick.bind(this,post._id)} type="button" classNames="btn btn-danger mr-1">
